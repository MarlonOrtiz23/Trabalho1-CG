...
#if (clock < 0.4)           //acrescentado if (se os frames estão abaixo da metade, mover camera)
        #declare var = (clock*10)-2;
#else
        #declare var = 2;    
#end
...
camera {
   location <-5, 10, -15>
   direction var*z  // z original = 2.25
   right x*1.33  // 1.33
   look_at <0,0,0> 
}
...
#declare var1 = 1;                        //acrescentado
#if (clock >= 0.4)
        #declare var1 = (clock*10)-4;    
#end
...
union {
    ...
    sphere { <-2.25, 0.45, -4.5>, 0.45
        texture { T_Wood20
            ...
            rotate <45, 10, 45>
            translate x*var1*2
            translate z*var1*2           // original x*10
        }
    }
